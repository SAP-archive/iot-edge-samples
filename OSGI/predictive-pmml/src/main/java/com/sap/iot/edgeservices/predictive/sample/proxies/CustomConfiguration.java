...
public class CustomConfiguration {
	...
	private String pmmlFileContentAsString; // pmml model file converted to an escaped string
	...
	public void mergeMissingValues(CustomConfiguration defaultConfiguration) {
		...
		if (StringUtils.isEmpty(pmmlFileContentAsString)) {
			pmmlFileContentAsString = defaultConfiguration.getPmmlFileContentAsString();
		}
	}
	...
	public String getPmmlFileContentAsString() {
		return pmmlFileContentAsString;
	}
}
