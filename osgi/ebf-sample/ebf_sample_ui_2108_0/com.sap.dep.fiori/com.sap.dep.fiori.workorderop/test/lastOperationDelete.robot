...
Attempt Operation Delete When You Cannot
    Change Global Sync Option Config      WOAllowNoOperation      N
    ...
    Element Should Contain                      jquery=div.sapMMessageToast     Cannot delete last
    Element Should Contain                      jquery=div.sapMMessageToast     operation from a work order
