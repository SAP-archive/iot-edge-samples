...
| Edge Gateway Service Reference Application | This sample is a custom extension service for testing the SAP Edge Gateway Service behavior. | [edge-gateway-app](https://github.com/SAP-samples/iot-edge-samples/tree/main/IoT_Edge/edge-gateway-service-ref-app)  |
